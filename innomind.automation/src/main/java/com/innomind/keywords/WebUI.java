...
import com.innomind.report.ExtentTestManager;
...
public class WebUI {
    ...
    public static void clickElement(By by) {
        ...
        waitForElementVisible(by).click();
    		...
    		LogUtils.error("Clicked on the element failed  " + by.toString() + " : " + ex.getMessage());
    		 ExtentReportManager.fail("Clicked on the element failed  " + by.toString());
