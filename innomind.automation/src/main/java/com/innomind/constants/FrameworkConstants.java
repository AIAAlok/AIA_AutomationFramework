...
public final class FrameworkConstants {
    ...
    //Test Data 
    public static final String EXCEL_ABI_DATA = PropertiesHelpers.getValue("EXCEL_ABI_DATA");
    
    
    
    
    public static final String BROWSER = PropertiesHelpers.getValue("BROWSER");
    public static final String URL_ABISignIn = PropertiesHelpers.getValue("URL_ABISignIn");
    public static final String URL_ABISignUp = PropertiesHelpers.getValue("URL_ABISignUp");
    public static final String URL_ABISignUp_UserName = PropertiesHelpers.getValue("URL_ABISignUp_UserName");
    public static final String URL_ABISignUp_Password = PropertiesHelpers.getValue("URL_ABISignUp_Password");
    ...
    public static final String ICON_SOCIAL_GITHUB_PAGE_URL = "https://innomind.com/";
    public static final String ICON_SOCIAL_LINKEDIN_URL = "https://www.linkedin.com/in/alok.bhagat/";
    public static final String ICON_SOCIAL_GITHUB_URL = "https://github.com/innomind";
